...
public class SPDSettings extends GameSettings {
	...
	public static void numberOfRuns( String category, int value ){
		put( category + "number_of_runs", value );
	}

	public static int numberOfRuns( String category ){
	...
	public static long averageRunTime( String category ){
		return getLong( category + "average", Long.MAX_VALUE );
	}

	public static void averageSplitTime( String category, int depth, long value ) {
		put( category + "time" + depth, value );
	}

	public static long averageSplitTime( String category, int depth ) {
		return getLong( category + "time" + depth, Integer.MAX_VALUE );
	}

	public static void personalBest( String category, long value ) {
		put( category + "pb", value );
	}

	public static long personalBest( String category ) {
		return getLong( category + "pb", Long.MAX_VALUE );
	}
